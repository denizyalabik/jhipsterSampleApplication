...
import { TestAc, TestAcService } from '../test-ac';
...
export class QuestionAnswerDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.testAcService.query()
            .subscribe((res: HttpResponse<TestAc[]>) => { this.testacs = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    }
    ...
    trackTestAcById(index: number, item: TestAc) {
        return item.id;
    }
